...
const MatchingExample = ({ positiveExample, negativeExample}) => {
  ...
  const [text, setText] = useState(buttonTextHide);
    ...
    <div className="search-wrapper">
      ...
      <div className="search">
        <div className="search-facets">
          ...
          <div class="contribute">Contribute to the Joern Query Database on GitHub:<br /><a href="https://github.com/joernio/joern/tree/master/querydb">https://github.com/joernio/joern/tree/master/querydb</a></div>
        </div>
